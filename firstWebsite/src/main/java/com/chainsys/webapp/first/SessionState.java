...
public class SessionState extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (submitValue.equals("result")) {
			...
			rd.forward(request, response);// parsing the request and response object received by the current servlet to
											// the forwarded servlet.
			...
			// session.serAttribute() stores the data in the collection using the key and
			// value.
