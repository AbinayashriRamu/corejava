 ...
 * database server.
 * 
 * @author shan3102 date : may 6 2022
 *
 */

/*
 * With JDBC, Different ways to establishing a database connection by calling
 * the method getConnection() of the DriverManager class. There are three
 * versions of this method: static Connection getConnection(String url) static
 * Connection getConnection(String url, Properties info) static Connection
